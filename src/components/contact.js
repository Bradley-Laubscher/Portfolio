    ...
    return (
        ...
        exit={{ x: window.innerWidth, opacity: 0, transition: {type: "tween", duration: 1}}}>
            <section className='contact-me'>
                <h2>Contact Me</h2>
                <ul>
                    <li>bradleylaubscher@gmail.com</li>
                    ...
                    <li><i className="fab fa-github-square" title='GitHub'></i>: <a href='https://github.com/Bradley-Laubscher' target='_blank' rel="noreferrer">Bradley-Laubscher</a></li>
                </ul>
            </section>
        </motion.div>
    )

            ...
            <section className='projects-container'>
                <div className='projects' style={{backgroundImage: 'url(/Resources/Marketplace.jpg)'}}>
                    <div className='tooltip'>
                        ...
                        <span className='tooltiptext'>A dynamic marketplace for multiple merchant types.<br/>Built using:<br/> Dart and Flutter</span>
                    </div>
                    <p className='project-name'>Marketplace</p>
                    <button><a href='https://bradley-laubscher.github.io/marketplace/' target='_blank' rel="noreferrer">Visit Site</a></button>
                </div>

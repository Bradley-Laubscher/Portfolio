      ...
      <section className="projects-container">
        ...
        >
          <div className="tooltip">
            <img src="/Resources/info-2.png" alt="more information icon" className="infoIcon" />
            <span className="tooltiptext">
              An application displaying surf conditions for some of Cape Town's local spots. Making use of the Open-Meteo marine API.<br /><br />Built using:<br /> Dart and Flutter
            </span>
          </div>
